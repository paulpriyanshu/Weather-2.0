...
function BasicInfo({props}) {
  ...
  return (
    ...
    <div style={{width:600,height:700,overflowWrap: 'break-word', wordWrap: 'break-word'}} className=" todo-container bg-blue-400 rounded-3xl  overflow-hidden border border-blue-500 shadow-2xl cursor-auto">
      
    <div className="flex flex-col relative left-20 top-10">  
      <div style={{width:400,height:200,overflowWrap: 'break-word', wordWrap: 'break-word'}} className="todo-container   bg-blue-400 rounded-3xl mb-5 overflow-hidden border border-blue-500 shadow-2xl cursor-auto">
      ...
      <div style={{width:400,height:300,overflowWrap: 'break-word', wordWrap: 'break-word'}} className="todo-container bg-blue-400   top-20 rounded-3xl  overflow-hidden border border-blue-500 shadow-2xl cursor-auto">
